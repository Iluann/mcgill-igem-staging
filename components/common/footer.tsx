    ...
    <footer className="bg-black text-left font-montserrat text-white py-4 px-10 z-[100] text-sm">
      <div className="flex justify-end items-start mr mb-2">
        <div className="px-8 py-2">
          ...
          <h2 className="font-bold hover:underline hover:cursor-pointer"><a target="_blank" rel="noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSeCIweaqbocjLH_5zbAGq6x84lZ65bHc8zjcK1rp07JvbYfrA/viewform">2027 Team Recruitment</a></h2>
        </div>
        <div className="px-8 py-2">
          <h2 className="py-2 font-bold hover:underline hover:cursor-pointer">
            Initiatives
