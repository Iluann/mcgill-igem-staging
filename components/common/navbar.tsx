          ...
          <div className="bothalign">
            <div className={styles.navanim}>
              <div className="grid lg:grid-cols-2 grid-cols-1 w-full h-full lg:gap-x-55 lg:gap-y-10 gap-5">
                ...
                <div>
                  <h1 className="uppercase lg:text-5xl text-xl lg:py-2 py-1 hover:underline hover:cursor-pointer"><a target="_blank"  rel="noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSeCIweaqbocjLH_5zbAGq6x84lZ65bHc8zjcK1rp07JvbYfrA/viewform">2027 Team Recruitment</a></h1>
                </div>
                <div>
